  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-imagerror="defaultImage" :src="staffPhoto">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">{{ userInfo.company }} - {{ name }} - {{ userInfo.departmentName }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
    ...
    <el-dialog :visible="showDialog" title="离职申请">
      <el-form ref="ruleForm" label-width="120px" :model="ruleForm" :rules="rules" @click="btnCancel">
        <el-form-item label="离职时间" prop="exceptTime">
          <!-- value-format绑定值为 字符串 类型 不指定则绑定值为 Date 对象 -->
          <el-date-picker
